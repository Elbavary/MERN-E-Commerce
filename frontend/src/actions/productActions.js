...
export const createProduct = product => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/products`, product, config);
...
export const createProductReview =
  (productId, review) => async (dispatch, getState) => {
    try {
      ...
      await axios.post(`${process.env.REACT_APP_BASE_URL}/api/products/${productId}/reviews`, review, config);
